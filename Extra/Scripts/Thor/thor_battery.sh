...
echo 1516800 > "$BASE/policy0/scaling_max_freq"
echo 1785600 > "$BASE/policy3/scaling_max_freq"
echo 1996800 > "$BASE/policy7/scaling_max_freq"

echo "Battery profile applied."